...
void ler_arq(char nomearq[100], int tamlinha){   //recebe o nome do arquivo e o tamanho da linha
...
void substituir(char *nomearq, int tamlinha, char *caractere, char *substitur){   //recebe o nome do arquivo
    char linha[tamlinha];  //linha tem até 100 caracteres
    char *separador; //ponteiro para separa o txt em sub strings
    char *substituto; substituto = caractere; 
    FILE * arq = fopen(nomearq, "r");  //topo arquivo tem um ponteiro que vai ser aberto em modo leitura
